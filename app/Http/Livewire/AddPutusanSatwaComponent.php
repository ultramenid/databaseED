...
class AddPutusanSatwaComponent extends Component
{
    public $provinsi = '. . .', $kabkota = '. . .', $isProvinsi, $isKabkota ;
    ...
    public function storeDatabase(){
        if($this->manualValidation()){
            DB::table('dbputusansatwa')->insert([
                'tahun' => $this->tahun,
    ...
    public function render()
    {
        ...
        return view('livewire.add-putusan-satwa-component', compact('provincies', 'kabkotas'));
    }
